...
namespace HRManager.Blazor.Services
{
    ...
    public class RegistrationService : IRegistrationService
    {
        ...
        public async Task<bool> Register(MemberRegisterDto dto)
        {
            ...
            var memberResponse = await apiClient.PostAsJsonAsync("members/register", dto, new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
            ...
            if (memberResult.Successful)
            {
                ...
                var idpResponse = await idpClient.PostAsJsonAsync("users/register", identityDto, new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
                ...
                if (!idpResponse.IsSuccessStatusCode)
                {
                    ...
                    var successCodeDeleteResponse = await idpClient.PostAsJsonAsync("members/member/delete", memberResult.Data, new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
                ...
                var apiResultDeleteResponse = await idpClient.PostAsJsonAsync("members/member/delete", memberResult.Data, new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
